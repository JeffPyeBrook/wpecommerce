...
?>
	<div class="ttfmake-wpecommerce-product-grid-options-container">
		<div class="ttfmake-wpecommerce-product-grid-options-column">
			<div class="ttfmake-type-select-wrapper">
				...
				<select id="<?php echo $section_name; ?>[type]" name="<?php echo $section_name; ?>[type]" data-model-attr="type">
					<?php foreach ( ttfmake_get_section_choices( 'type', 'wpecommerce-product-grid' ) as $value => $label ) : ?>
			...
			<div class="ttfmake-taxonomy-select-wrapper">
				...
				<select id="<?php echo $section_name; ?>[taxonomy]" name="<?php echo $section_name; ?>[taxonomy]" data-model-attr="taxonomy">
					<?php foreach ( ttfmake_get_section_choices( 'taxonomy', 'wpecommerce-product-grid' ) as $value => $label ) : ?>
			...
			<div class="ttfmake-sortby-select-wrapper">
				...
				<select id="<?php echo $section_name; ?>[sortby]" name="<?php echo $section_name; ?>[sortby]" data-model-attr="sortby">
					<?php foreach ( ttfmake_get_section_choices( 'sortby', 'wpecommerce-product-grid' ) as $value => $label ) : ?>
		...
		<div class="ttfmake-wpecommerce-product-grid-options-column">
			<div class="ttfmake-columns-select-wrapper">
				...
				<select id="<?php echo $section_name; ?>[columns]" name="<?php echo $section_name; ?>[columns]" data-model-attr="columns">
					<?php foreach ( ttfmake_get_section_choices( 'columns', 'wpecommerce-product-grid' ) as $value => $label ) : ?>
			...
			<h4 class="ttfmake-wpecommerce-product-grid-options-title">
		...
		<div class="ttfmake-wpecommerce-product-grid-options-column">
			...
			<?php if ( get_option( 'wpecommerce_enable_review_rating' ) !== 'no' ) : ?>
			<p>
